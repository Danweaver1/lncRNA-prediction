#!/usr/bin/env perl
#adapted from Griffith lab RNAseq tutorial, see:
#	https://github.com/griffithlab/rnaseq_tutorial/blob/master/scripts/stringtie_expression_matrix.pl
#script has very little modification - identifies MSTRG IDs instead of ERCC.
use strict;
use warnings;
use Getopt::Long;
use IO::File;
